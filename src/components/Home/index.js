...
const Home = () => {
    ...
    const handlePreponeSubmit = async () => {
        try {
            ...
            const response = await fetch('https://exsel-backend-5.onrender.com/api/prepone-arrival', {
                method: 'POST',
                headers: {
            ...
            if (preponeInfo.additional_cost > 0) {
                ...
                const orderResponse = await fetch('https://exsel-backend-5.onrender.com/api/create-prepone-order', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                ...
                const confirmResponse = await fetch('https://exsel-backend-5.onrender.com/api/confirm-prepone', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    const handleAreaChange = async (e) => {
        ...
        try {
            const response = await fetch(
                `https://exsel-backend-5.onrender.com/api/parking-lots/${formData.state}/${formData.district}/${area}`
            );
            const data = await response.json();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const bookingResponse = await fetch('https://exsel-backend-5.onrender.com/api/book-slot', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
            ...
            const orderResponse = await fetch('https://exsel-backend-5.onrender.com/api/create-order', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
    ...
    const verifyPayment = async (orderId, bookingId) => {
        try {
            const response = await fetch('https://exsel-backend-5.onrender.com/api/verify-payment', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const verifyExtensionPayment = async (orderId, bookingId, extensionId) => {
        try {
            const response = await fetch('https://exsel-backend-5.onrender.com/api/verify-extension-payment', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    useEffect(() => {
        const fetchUserDetails = async () => {
            try {
                ...
                const response = await fetch(`https://exsel-backend-5.onrender.com/api/user-details?userId=${userId}`, {
                    headers: {
    ...
    useEffect(() => {
        const fetchStates = async () => {
            try {
                const response = await fetch('https://exsel-backend-5.onrender.com/api/states');
                const data = await response.json();
    ...
    const handleStateChange = async (e) => {
        ...
        try {
            const response = await fetch(`https://exsel-backend-5.onrender.com/api/districts/${state}`);
    ...
    const handleDistrictChange = async (e) => {
        ...
        try {
            const response = await fetch(
                `https://exsel-backend-5.onrender.com/api/areas/${formData.state}/${district}`
            );
    ...
    const handleStatusUpdate = async (bookingId, newStatus) => {
        try {
            ...
            const response = await fetch('https://exsel-backend-5.onrender.com/api/update-booking-status', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const fetchBookingHistory = async () => {
        try {
            ...
            const response = await fetch(`https://exsel-backend-5.onrender.com/api/booking-history/${userDetails.id}`);
            const data = await response.json();
    ...
    const fetchAvailableSlots = async (parkingLotId, date, time) => {
        try {
            const response = await fetch(
                `https://exsel-backend-5.onrender.com/api/available-slots/${parkingLotId}/${date}/${time}`
            );
            const data = await response.json();
            if (response.ok) {
    ...
    const checkAvailability = async () => {
        ...
        try {
            const response = await fetch('https://exsel-backend-5.onrender.com/api/check-slot-availability', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
    ...
    const submitExtendBooking = async () => {
        ...
        try {
            ...
            const response = await fetch('https://exsel-backend-5.onrender.com/api/extend-booking', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const submitExtendTime = async () => {
        ...
        try {
            ...
            const extensionResponse = await fetch('https://exsel-backend-5.onrender.com/api/create-extension-request', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
            ...
            const orderResponse = await fetch('https://exsel-backend-5.onrender.com/api/create-extension-order', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
